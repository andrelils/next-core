...
const ScanPreviewBricksPlugin = require("./ScanPreviewBricksPlugin");
...
module.exports =
  ...
  ({ scope = "bricks", copyFiles = [], ignores = [] } = {}) => {
    const isForEditors = type === "editors";
    const isForPreviews = type === "previews";
    ...
    const dll = isForEditors /*  || isForPreviews */
    ...
    return {
      ...
      plugins: [
        isForEditors
          ...
          : isForPreviews
          ? new ScanPreviewBricksPlugin(packageName)
          : scope === "templates"
